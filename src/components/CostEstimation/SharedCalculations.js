...
export const getBuffaloDetails = (treeData) => {
...
export const calculateMonthlyRevenueForBuffalo = (acquisitionMonth, currentMonth, currentYear, startYear) => {
...
export const calculateYearlyCPFCost = (treeData, buffaloDetails, calculateAgeInMonths) => {
  const cpfCostByYear = {};
...
export const calculateInitialInvestment = (treeData) => {
...
export const calculateDetailedMonthlyRevenue = (treeData, buffaloDetails, calculateMonthlyRevenueForBuffalo, calculateAgeInMonths, getBuffaloValueByAge) => {
